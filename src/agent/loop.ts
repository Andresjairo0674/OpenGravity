...
export const processUserMessage = async (userId: number, userMessage: string, forceAudio: boolean = false): Promise<{text: string, audioPath?: string}> => {
  ...
  const contextMessages: any[] = rawHistory.map(row => ({
